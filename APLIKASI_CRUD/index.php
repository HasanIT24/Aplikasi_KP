    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="" class="btn btn-warning" data-bs-toogle="modal" data-bs-target="#modalUbah"<?=$no ?>>Ubah</a>
                                <a href="" class="btn btn-danger" data-bs-toogle="modal" data-bs-target="#modalHapus"<?=$no ?>>Hapus</a>
                            </td>
                        </tr>

                     <!-- Awal Modal Ubah-->
                <div class="modal fade modal-lg" id="modalUbah<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">z
                ...
                <!-- Awal Modal Tambah-->
                <div class="modal fade modal-lg" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">z
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Form Data Inventaris</h5>
                ...
                <!-- Awal Modal Hapus-->
                <div class="modal fade modal-lg" id="modalHapus<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">z
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Form Data Inventaris</h5>
                    ...
                    <form method="POST" action="aksi_crud.php">
                        <div class="modal-body modal-content">
                            <h5 class="text-center">Apakah anda yakin akan menghapus data ini</h5><br>
